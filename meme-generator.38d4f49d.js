...
`,(class e extends HTMLElement{static ERROR_CODES={FILE_DIALOG_OPEN_FAILED:"FILE_DIALOG_OPEN_FAILED",FILE_INPUT_CHANGE_FAILED:"FILE_INPUT_CHANGE_FAILED",DROP_EVENT_PROCESSING_FAILED:"DROP_EVENT_PROCESSING_FAILED",UNKNOWN_ERROR:"UNKNOWN_ERROR"};static REJECTION_CODES={TOO_MANY_FILES:"TOO_MANY_FILES",FILE_TOO_LARGE:"FILE_TOO_LARGE",FILE_TOO_SMALL:"FILE_TOO_SMALL",INVALID_MIME_TYPE:"INVALID_MIME_TYPE"};#t=null;#n=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open",delegatesFocus:!0}).appendChild(ta.content.cloneNode(!0)),this.shadowRoot&&(this.#t=this.shadowRoot.getElementById("file-input"),this.#n=this.shadowRoot.getElementById("dropzone"))}static get observedAttributes(){return["accept","disabled","multiple"]}attributeChangedCallback(e,t,o){"accept"===e&&t!==o&&this.#t&&(this.#t.accept=this.accept),"disabled"===e&&t!==o&&this.#t&&(this.#t.disabled=this.disabled,this.disabled?(this.#n?.removeAttribute("tabindex"),this.#n?.setAttribute("aria-disabled","true")):(this.#n?.setAttribute("tabindex","0"),this.#n?.setAttribute("aria-disabled","false"))),"multiple"===e&&t!==o&&this.#t&&(this.#t.multiple=this.multiple)}connectedCallback(){this.#l("accept"),this.#l("disabled"),this.#l("maxFiles"),this.#l("maxSize"),this.#l("minSize"),this.#l("multiple"),this.#l("autoFocus"),this.#l("noStyle"),this.#t?.addEventListener("change",this.#c),this.#n?.addEventListener("dragenter",this.#o),this.#n?.addEventListener("dragover",this.#e),this.#n?.addEventListener("dragleave",this.#h),this.#n?.addEventListener("drop",this.#m),this.#n?.addEventListener("click",this.#u),this.#n?.addEventListener("keyup",this.#g),this.autoFocus&&this.#n?.focus()}disconnectedCallback(){this.#t?.removeEventListener("change",this.#c),this.#n?.removeEventListener("dragenter",this.#o),this.#n?.removeEventListener("dragover",this.#e),this.#n?.removeEventListener("dragleave",this.#h),this.#n?.removeEventListener("drop",this.#m),this.#n?.removeEventListener("click",this.#u),this.#n?.removeEventListener("keyup",this.#g)}get accept(){return this.getAttribute("accept")||""}set accept(e){this.setAttribute("accept",null!=e?e.toString():e)}get disabled(){return this.hasAttribute("disabled")}set disabled(e){this.toggleAttribute("disabled",!!e)}get maxFiles(){let e=Number(this.getAttribute("max-files"))||0;return e<=0?1/0:Math.floor(Math.abs(e))}set maxFiles(e){this.setAttribute("max-files",null!=e?e.toString():e)}get maxSize(){let e=this.getAttribute("max-size");if(null===e)return 1/0;let t=Number(e);return Number.isNaN(t)?1/0:t}set maxSize(e){this.setAttribute("max-size",null!=e?e.toString():e)}get minSize(){let e=this.getAttribute("min-size");if(null===e)return 0;let t=Number(e);return Number.isNaN(t)?0:t}set minSize(e){this.setAttribute("min-size",null!=e?e.toString():e)}get multiple(){return this.hasAttribute("multiple")}set multiple(e){this.toggleAttribute("multiple",!!e)}get autoFocus(){return this.hasAttribute("auto-focus")}set autoFocus(e){this.toggleAttribute("auto-focus",!!e)}get noStyle(){return this.hasAttribute("no-style")}set noStyle(e){this.toggleAttribute("no-style",!!e)}#r(e,t,o){let i=new CustomEvent(`${tn}-${e}`,{bubbles:!0,composed:!0,cancelable:!1,...o,detail:t});return this.dispatchEvent(i)}#a(e,t){this.#r("error",{code:e,error:t})}#c=async t=>{try{this.#i(await tt(t))}catch(t){this.#a(e.ERROR_CODES.FILE_INPUT_CHANGE_FAILED,t)}};#o=()=>{this.disabled||this.#r("dragenter")};#e=e=>{if(e.preventDefault(),this.disabled){e.dataTransfer.dropEffect="none";return}e.dataTransfer.dropEffect="copy",this.#n&&(this.#n.classList.add("dropzone--dragover"),this.#n.part.add("dropzone--dragover")),this.#r("dragover")};#h=()=>{this.disabled||(this.#n&&(this.#n.classList.remove("dropzone--dragover"),this.#n.part.remove("dropzone--dragover")),this.#r("dragleave"))};#m=async t=>{if(!this.disabled){t.preventDefault(),this.#n&&(this.#n.classList.remove("dropzone--dragover"),this.#n.part.remove("dropzone--dragover"));try{this.#i(await tt(t))}catch(t){this.#a(e.ERROR_CODES.DROP_EVENT_PROCESSING_FAILED,t)}}};#u=()=>{this.disabled||this.openFileDialog()};#g=e=>{this.disabled||(" "===e.key||"Enter"===e.key)&&this.openFileDialog()};#i(t){if(!Array.isArray(t)||!t.length)return;let o=[],i=[],n=t.length;if(!this.multiple&&n>1)for(let o of t)i.push({file:o,errors:[{code:e.REJECTION_CODES.TOO_MANY_FILES,message:"Too many files selected. Only 1 file is allowed."}]});else if(this.multiple&&n>this.maxFiles)for(let o of t)i.push({file:o,errors:[{code:e.REJECTION_CODES.TOO_MANY_FILES,message:`Too many files selected. Only ${this.maxFiles} ${this.maxFiles>1?"files are":"file is"} allowed.`}]});else for(let n of t){let t=function(e,t=""){if(!t)return!0;let o=[...new Set(t.split(",").map(e=>e.trim()).filter(Boolean))],i=e.type,n=i.replace(/\/.*$/,"");for(let t of o)if("."===t.charAt(0)){if(-1!==e.name.toLowerCase().indexOf(t.toLowerCase(),e.name.length-t.length))return!0}else if(/\/\*$/.test(t)){if(n===t.replace(/\/.*$/,""))return!0}else if(i===t)return!0;return!1}(n,this.accept),a=n.size>this.maxSize,r=n.size<this.minSize;if(!t||a||r){let o=[];t||o.push({code:e.REJECTION_CODES.INVALID_MIME_TYPE,message:`File type "${n.type}" is not accepted.`}),a&&o.push({code:e.REJECTION_CODES.FILE_TOO_LARGE,message:`File size ${n.size} exceeds the maximum size of ${this.maxSize}.`}),r&&o.push({code:e.REJECTION_CODES.FILE_TOO_SMALL,message:`File size ${n.size} is smaller than the minimum size of ${this.minSize}.`}),i.push({file:n,errors:o})}else o.push(n)}this.#r("drop",{acceptedFiles:o,rejectedFiles:i}),o.length>0&&this.#r("drop-accepted",{acceptedFiles:o}),i.length>0&&this.#r("drop-rejected",{rejectedFiles:i}),this.#t&&(this.#t.value=this.#t.defaultValue)}openFileDialog(){if(!(this.disabled||!this.#t)){if("showPicker"in HTMLInputElement.prototype&&"function"==typeof this.#t.showPicker){try{this.#t.showPicker()}catch(t){this.#a(e.ERROR_CODES.FILE_DIALOG_OPEN_FAILED,t)}return}this.#t.click()}}#l(e){if(Object.prototype.hasOwnProperty.call(this,e)){let t=this[e];delete this[e],this[e]=t}}static defineCustomElement(t=tn){"u">typeof window&&!window.customElements.get(t)&&window.customElements.define(t,e)}}).defineCustomElement();var ts=String.raw,tl=class e extends EventTarget{#r=!1;#t=0;#n=0;#e=0;#o=0;#m=0;constructor(e){super();let{elapsed:t,duration:o}={elapsed:0,duration:1/0,...e};if("number"!=typeof t||Number.isNaN(t))throw TypeError("elapsed option must be a number");if("number"!=typeof o||Number.isNaN(o))throw TypeError("duration option must be a number");this.#r=!1,this.#t=Math.max(0,o),this.#n=Math.min(Math.max(0,t),this.#t),this.#e=this.#n,this.#o=0,this.#m=this.#n}#l(e){this.dispatchEvent(new Event(e))}#c=()=>{if(!this.#r)return;let t=e.now()-this.#o+this.#m;this.#n=Math.min(t,this.#t),this.#l("tick"),t<this.#t?requestAnimationFrame(this.#c):(this.#r=!1,this.#m=this.#n,this.#l("finish"))};on(e,t,o){return this.addEventListener(e,t,o),this}off(e,t,o){return this.removeEventListener(e,t,o),this}start(){return this.#r||this.#n>=this.#t||(this.#r=!0,this.#o=e.now(),this.#l("start"),requestAnimationFrame(this.#c)),this}stop(){return this.#r&&(this.#r=!1,this.#m=this.#n,this.#l("stop")),this}reset(){return this.#r=!1,this.#n=this.#e,this.#m=this.#e,this.#o=0,this.#l("reset"),this}time(){return{elapsed:this.#n,remaining:this.remaining}}get elapsed(){return this.#n}get remaining(){return Math.max(0,this.#t-this.#n)}get running(){return this.#r}static now(){return"performance"in window?performance.now():Date.now()}},tc="alert-element",td="alert-after-show",tu="alert-after-hide",th=String.raw,tm=String.raw,tp=((o=Object.assign(document.createElement("div"),{className:"alert-toast-stack"})).attachShadow({mode:"open"}).innerHTML=ts`
    <style>
      :host {
        display: contents;
        box-sizing: border-box;
...
`,tb=document.createElement("template");tb.innerHTML=th`
  <style>
    ${tg}
  </style>
...
`,(class e extends HTMLElement{#r=!1;#t=null;#n=null;#e=null;#o=null;#m;static customAnimations;#l="api";#c=null;#b=null;#i=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tb.content.cloneNode(!0))}static get observedAttributes(){return["open","duration","close-label","announce","countdown"]}attributeChangedCallback(e,t,o){if(!(!this.#r||t===o))switch(e){case"open":this.open?(this.duration!==1/0&&this.#c?.start(),this.#t?.removeAttribute("hidden"),this.#i?.style.setProperty("transform","scaleX(1)"),this.#f("alert-show"),this.#v(this.#t)?.finished.finally(()=>{this.#f(td)})):(this.duration!==1/0&&this.#c?.reset(),this.#f("alert-hide",{reason:this.#l}),this.#y(this.#t)?.finished.finally(()=>{this.#t?.setAttribute("hidden",""),this.#f(tu,{reason:this.#l}),this.#l="api"}));break;case"duration":this.#c?.stop().off("tick",this.#u).off("finish",this.#h),this.#c=new tl({duration:this.duration}).on("tick",this.#u).on("finish",this.#h),this.open&&this.duration!==1/0&&!this.#w()&&this.#c.start(),this.duration===1/0&&this.#i?.style.setProperty("transform","scaleX(1)");break;case"close-label":this.#g();break;case"announce":"none"!==this.announce?this.#t?.setAttribute("role",this.announce):this.#t?.removeAttribute("role");break;case"countdown":this.#b?.toggleAttribute("hidden",!this.countdown)}}get closable(){return this.hasAttribute("closable")}set closable(e){this.toggleAttribute("closable",!!e)}get open(){return this.hasAttribute("open")}set open(e){this.toggleAttribute("open",!!e)}get duration(){let e=this.getAttribute("duration");if(null===e||""===e)return 1/0;let t=Number(e);return t<=0?10:Number.isNaN(t)?1/0:t}set duration(e){this.setAttribute("duration",null!=e?e.toString():e)}get variant(){return this.getAttribute("variant")||""}set variant(e){this.setAttribute("variant",e)}get closeLabel(){return this.getAttribute("close-label")||"Close"}set closeLabel(e){this.setAttribute("close-label",null!=e?e.toString():e)}get announce(){let e=this.getAttribute("announce");return"alert"===e||"status"===e||"none"===e?e:"alert"}set announce(e){this.setAttribute("announce",null!=e?e.toString():e)}get countdown(){return this.hasAttribute("countdown")}set countdown(e){this.toggleAttribute("countdown",!!e)}get noAnimations(){return this.hasAttribute("no-animations")}set noAnimations(e){this.toggleAttribute("no-animations",!!e)}get customAnimations(){return this.#m}set customAnimations(e){this.#m=e}connectedCallback(){this.#a("closable"),this.#a("open"),this.#a("duration"),this.#a("variant"),this.#a("closeLabel"),this.#a("announce"),this.#a("countdown"),this.#a("noAnimations"),this.#a("customAnimations"),this.#t=this.shadowRoot?.querySelector(".alert")??null,this.#n=this.shadowRoot?.querySelector(".alert__close")??null,this.#e=this.shadowRoot?.querySelector('slot[name="close"]')??null,this.#b=this.shadowRoot?.querySelector(".alert__countdown")??null,this.#i=this.shadowRoot?.querySelector(".alert__countdown-elapsed")??null,this.#n?.addEventListener("click",this.#E),this.#e?.addEventListener("slotchange",this.#p),this.addEventListener("mouseenter",this.#s),this.addEventListener("mouseleave",this.#d),this.addEventListener("focusin",this.#s),this.addEventListener("focusout",this.#d),this.addEventListener("command",this.#k),this.#c=new tl({duration:this.duration}).on("tick",this.#u).on("finish",this.#h),this.open?(this.duration!==1/0&&this.#c?.start(),this.#t?.removeAttribute("hidden")):this.#t?.setAttribute("hidden",""),this.closeLabel&&this.#g(),"none"!==this.announce?this.#t?.setAttribute("role",this.announce):this.#t?.removeAttribute("role"),this.#b?.toggleAttribute("hidden",!this.countdown),this.#r=!0}disconnectedCallback(){this.#r=!1,this.#c?.stop().off("tick",this.#u).off("finish",this.#h),this.#c=null,this.#n?.removeEventListener("click",this.#E),this.#e?.removeEventListener("slotchange",this.#p),this.removeEventListener("mouseenter",this.#s),this.removeEventListener("mouseleave",this.#d),this.removeEventListener("focusin",this.#s),this.removeEventListener("focusout",this.#d),this.removeEventListener("command",this.#k)}connectedMoveCallback(){}#u=e=>{if(!this.countdown||!this.#i)return;let{remaining:t}=e.currentTarget,o=t/this.duration;this.#i.style.transform=`scaleX(${o})`};#h=()=>{this.#l="timeout",this.open=!1};#E=()=>{this.closable&&(this.#l="user",this.open=!1)};#s=()=>{this.open&&this.duration!==1/0&&this.#c?.stop()};#d=()=>{!this.open||this.duration===1/0||this.#w()||this.#c?.start()};#p=()=>{this.#g()};#k=e=>{switch(e.command){case"--alert-show":this.open=!0;break;case"--alert-hide":this.#l="api",this.open=!1}};#g(){this.#n&&((this.#e?.assignedElements()||[])?.some(e=>e.textContent?.replace(/\s/g,"")!=="")?this.#n.removeAttribute("aria-label"):this.#n.setAttribute("aria-label",this.closeLabel))}#x(){let t=window.matchMedia("(prefers-reduced-motion: reduce)").matches,o={show:{keyframes:[{opacity:0,transform:"scale(0.9)"},{opacity:1,transform:"scale(1)"}],options:{duration:250,easing:"ease"}},hide:{keyframes:[{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.9)"}],options:{duration:250,easing:"ease"}}},i=this.customAnimations||e.customAnimations||{},n=t||this.noAnimations||null===this.customAnimations||null===e.customAnimations,a=e=>{let t=i[e]?.options??{},a=o[e].options;return{...a,...t,duration:n?0:t.duration??a.duration}};return{show:{keyframes:i.show?.keyframes??o.show.keyframes,options:a("show")},hide:{keyframes:i.hide?.keyframes??o.hide.keyframes,options:a("hide")}}}#v(e){let{keyframes:t,options:o}=this.#x().show;return e?.animate(t,o)}#y(e){let{keyframes:t,options:o}=this.#x().hide;return e?.animate(t,o)}#f(e,t=null){let o=new CustomEvent(e,{bubbles:!0,composed:!0,detail:t});this.dispatchEvent(o)}#S(e,t){return new Promise(o=>{e.addEventListener(t,t=>{t.target===e&&o()},{once:!0})})}#w(){return this.matches(":focus-within")}show(){return this.open?Promise.resolve():(this.open=!0,this.#S(this,td))}hide(){return this.open?(this.open=!1,this.#S(this,tu)):Promise.resolve()}toast(e={}){if(e={forceRestart:!1,...e},this.#o){if(!e.forceRestart)return this.#o.promise;this.#o.resolve(),this.#o.cleanup()}let t=()=>{},o=new Promise(e=>t=e),i=()=>{this.#o?.resolve(),this.#o?.cleanup()};this.#o={promise:o,resolve:t,cleanup:()=>{this.removeEventListener(tu,i),this.parentNode===tp&&tp.removeChild(this),tp.querySelector(tc)||tp.remove(),this.open=!1,this.#o=null}},tp.parentElement||document.body.append(tp),tp.appendChild(this),this.#t?.setAttribute("data-toast",""),this.open=!0;let n=tp.shadowRoot?.querySelector(".stack");return n?.scrollTo({top:n.scrollHeight}),this.addEventListener(tu,i,{once:!0}),o}#a(e){if(Object.prototype.hasOwnProperty.call(this,e)){let t=this[e];delete this[e],this[e]=t}}static defineCustomElement(t=tc){"u">typeof window&&!window.customElements.get(t)&&window.customElements.define(t,e)}}).defineCustomElement();let tf=["image/jpg","image/jpeg","image/png","image/apng","image/gif","image/webp","image/avif"],tv=(e="",t="")=>{let o=Math.random().toString(36).substring(2,8);return`${"string"==typeof e&&""!==e?e+"-":""}${o}${"string"==typeof t&&""!==t?"-"+t:""}`},ty=async(e={})=>{let t=await fetch(e.url),o=await t.blob(),i=e.mimeType||o.type||"";if(!tf.includes(i))throw Error(`This is not an accepted image format. Accepted MIME types are: ${tf.join(", ")}`);return new File([o],e.filename||"",o)},tw=localStorage,tE=new class{#A=null;#L=null;constructor(e,t=localStorage){if(!e)throw Error("Storage prefix is required");if(t!==localStorage&&t!==sessionStorage)throw Error("Storage provider is not supported");this.#A=e,this.#L=t}set(e,t){try{this.#L.setItem(`${this.#A}${e}`,JSON.stringify(t))}catch(e){console.error("Error saving to storage",e)}}get(e){try{let t=this.#L.getItem(`${this.#A}${e}`);return t?JSON.parse(t):null}catch(e){return console.error("Error getting from storage",e),null}}}("meme-generator/",tw);var tk={};tk=n("lRBOd");var tx={};tx=n("hOimC");var tS={};tS=n("c5nso");var tA={};tA=n("917SN");var tL={};tL=n("kCRYk");var tC={};tC=n("7mTjM");var t_={};t_=n("bNJU7");var tT={};tT=n("2zTNP");var tj={};tj=n("6U5us");var tz={};tz=n("jadM2");var tI={};tI=n("4rZHV");let tO=[{name:"Pressuru",label:"Pressuru",path:i(tk),style:"normal",weight:"400"},{name:"Oswald-Regular",label:"Oswald",path:i(tx),style:"normal",weight:"400"},{name:"Oswald-Bold",label:"Oswald Bold",path:i(tS),style:"normal",weight:"700"},{name:"Roboto-Regular",label:"Roboto",path:i(tA),style:"normal",weight:"400"},{name:"Roboto-Bold",label:"Roboto Bold",path:i(tL),style:"normal",weight:"700"},{name:"RobotoCondensed-Regular",label:"Roboto Condensed",path:i(tC),style:"normal",weight:"400"},{name:"RobotoCondensed-Bold",label:"Roboto Condensed Bold",path:i(t_),style:"normal",weight:"700"},{name:"CourierPrime-Regular",label:"Courier Prime",path:i(tT),style:"normal",weight:"400"},{name:"CourierPrime-Bold",label:"Courier Prime Bold",path:i(tj),style:"normal",weight:"700"},{name:"OpenSans-Regular",label:"Open Sans",path:i(tz),style:"normal",weight:"400"},{name:"OpenSans-Bold",label:"Open Sans Bold",path:i(tI),style:"normal",weight:"400"}],t$=async(e,t,o={})=>{try{let i=new FontFace(e,`url(${t})`,{...o});await i.load(),document.fonts.add(i)}catch(e){console.error(e)}},tM={id:"",text:"",fillColor:"#ffffff",strokeColor:"#000000",font:"Pressuru",fontSize:40,fontWeight:"normal",textAlign:"center",shadowBlur:0,strokeWidth:1.5,offsetY:0,offsetX:0,rotate:0,allCaps:!0,textBackgroundEnabled:!1,textBackgroundColor:"#000000"},tR=new Map;class tB{constructor(e){let t=tv("textbox",Date.now().toString(36));this.data=e?{...e,id:t}:{...tM,id:t},tR.set(t,this),document.dispatchEvent(new CustomEvent("textbox-create",{bubbles:!0,composed:!0,detail:{textbox:this}}))}getData(){return this.data}static hasDefaultValues(e){for(let t of Object.keys(tM))if("id"!==t&&e[t]!==tM[t])return!1;return!0}static create(e){return new tB(e)}static getAll(){return tR}static getById(e){return tR.get(e)}static remove(e){tR.delete(e),document.dispatchEvent(new CustomEvent("textbox-remove",{bubbles:!0,composed:!0,detail:{id:e}}))}static createElement(e,t=!0){if(!(e instanceof tB))return;let o=e.getData(),{id:i,text:n,fillColor:a,strokeColor:r,fontSize:s,shadowBlur:l,strokeWidth:c,offsetX:d,offsetY:u,rotate:h,textBackgroundColor:m}=o,p=`
    <div class="d-flex align-items-center" data-section="basic-settings">
      ...
      <textarea class="form-control meme-text" type="text" data-input="text" autocomplete="off" rows="1" placeholder="Text #${tR.size}">${n}</textarea>
    ...
    <div class="p-2" data-section="advanced-settings" hidden>
        ...
        <div class="col-4 mb-3">
          ...
          <select class="form-select" data-input="font" id="fontInput_${i}">
            ...
            <optgroup label="Google fonts">
              ${tO.map(({name:e,label:t})=>`<option value="${e}">${t}</option>`)}
            </optgroup>
          </select>
        </div>
      ...
      <div class="row g-2">
        ...
        <div class="col-4 mb-3">
          ...
          <input class="form-control" type="number" min="0" max="20" step="0.5" value="${c}" data-input="strokeWidth" id="strokeWidthInput_${i}">
        </div>
      ...
      <div class="row g-2">
        ...
        <div class="col-4 mb-3">
          ...
          <input class="form-control" type="number" value="${d}" data-input="offsetX" id="offsetXInput_${i}">
        </div>
  ...
  `,g=document.createDocumentFragment(),b=document.createElement("div");b.setAttribute("id",i),b.setAttribute("data-section","textbox"),b.className="bg-body-tertiary border shadow-sm mb-3 rounded",b.innerHTML=p,b.querySelectorAll("select").forEach(e=>e.value=o[e.dataset.input]),b.querySelectorAll('input[type="checkbox"]').forEach(e=>e.checked=o[e.dataset.input]);let f=g.appendChild(b);return t&&setTimeout(()=>f.querySelector('[data-input="text"]').focus(),0),f}}class tN{#C=null;#_=null;constructor(e){this.#C=e,this.#_=this.#C.getContext("2d")}get width(){return this.#C.width}set width(e){this.#C.width=e}get height(){return this.#C.height}set height(e){this.#C.height=e}getDimensions(){return{width:this.width,height:this.height}}setDimensions({width:e,height:t}){return this.width=e,this.height=t,this}toDataURL(){return this.#C.toDataURL()}draw(e,t=new Map){if(null==e)return;let o=this.#C,i=this.#_;i.clearRect(0,0,o.width,o.height),"string"==typeof e?(i.fillStyle=e,i.fillRect(0,0,o.width,o.height)):i.drawImage(e,0,0,o.width,o.height);let n=0;return t.forEach(e=>{let{data:t}=e;n+=1,i.save(),i.font=`${t.fontWeight} ${t.fontSize*o.width/1e3}px ${t.font}`,i.textAlign=t.textAlign,i.strokeStyle=t.strokeColor;let a=o.width/2,r=t.shadowBlur,s=(!0===t.allCaps?t.text.toUpperCase():t.text).split("\n").filter(e=>""!==e.trim()),l=i.measureText(s[0]),c=l.actualBoundingBoxAscent+l.actualBoundingBoxDescent,d=t.textBackgroundEnabled?c/4:0,u=c+t.fontSize/4+d;i.translate(a+t.offsetX,u*n+t.offsetY),i.rotate(Math.min(t.rotate,360)*Math.PI/180),t.textBackgroundEnabled&&(i.fillStyle=t.textBackgroundColor,s.forEach((e,o)=>{if(e){let n=i.measureText(e),a=n.width,r=n.actualBoundingBoxAscent+n.actualBoundingBoxDescent,s="left"===t.textAlign?0:"right"===t.textAlign?-a:-a/2;i.fillRect(s-d,o*u-r-d,a+2*d,r+2*d)}})),i.save(),0!==r&&(i.shadowOffsetX=0,i.shadowOffsetY=0,i.shadowBlur=Math.min(r,20),i.shadowColor=t.strokeColor),i.fillStyle=t.fillColor,s.forEach((e,t)=>i.fillText(e,0,t*u)),i.restore(),t.strokeWidth>0&&(i.lineWidth=Math.min(t.strokeWidth,20),s.forEach((e,t)=>i.strokeText(e,0,t*u))),i.restore()}),this}clear(){return this.#_.clearRect(0,0,this.#C.width,this.#C.height),this}show(){return this.#C.hidden=!1,this}hide(){return this.#C.hidden=!0,this}static createInstance(e){return new tN(e)}}function tD(e,t={}){var o;let i,n={duration:5e3,variant:"neutral",countdown:!0,icon:"",...t},a={info:`
    ...
    `}[n.icon||n.variant]||"";return Object.assign(document.createElement("alert-element"),{closable:!0,duration:n.duration,variant:n.variant,countdown:n.countdown,innerHTML:`${a?`<span slot="icon">${a}</span>`:""}${n.trustDangerousInnerHTML?e:(o=e,(i=document.createElement("div")).textContent=o,i.innerHTML)}`}).toast()}let tF=tN.createInstance(document.getElementById("canvas")),tP=document.getElementById("videoModal"),tH=document.getElementById("downloadModal"),tq=document.querySelector("capture-photo"),tU=document.getElementById("cameraSelect"),tV=document.getElementById("capturePhotoButton"),tW=document.getElementById("torchButton"),tG=document.querySelector("files-dropzone"),tK=document.getElementById("instructions"),tY=document.getElementById("imageUploadMethodSelect"),tX=document.getElementById("fileSelectBtn"),tJ=document.getElementById("imageUrlForm"),tQ=document.getElementById("addTextboxBtn"),tZ=document.getElementById("textboxesContainer"),t0=document.getElementById("generateMemeBtn"),t1=document.getElementById("openVideoModalBtn"),t5=document.getElementById("downloadMemeBtn"),t3=document.getElementById("downloadMemePreview"),t2=document.querySelector("web-share"),t4=document.getElementById("gallery"),t9=document.getElementById("gallerySearch"),t8=t4.querySelector(".gallery__no-results"),t6=document.getElementById("solidColorForm"),t7=document.querySelectorAll(".upload-method"),oe=document.getElementById("removeConfirmationModal"),ot=document.getElementById("removeTextForm"),oo=document.getElementById("maxImageDimensionsForm"),oi=oo.maxImageDimensions,on=document.getElementById("clearCanvasBtn"),oa=tE.get("maxImageDimensions"),or=!1,os=null,ol=null;async function oc(){let e=tF.toDataURL("image/png"),t=`${tv("meme")}.png`,o=e.replace("image/png","image/octet-stream");if(t5.download=t,t5.href=o,t3.width=tF.getDimensions().width,t3.height=tF.getDimensions().height,t3.src=o,eY())try{let o=await ty({url:e,filename:t,mimeType:"image/png"}).catch(e=>{tD(`<strong>Error preparing meme for sharing</strong><br><small>${e.message}</small>`,{trustDangerousInnerHTML:!0,variant:"danger"})});o&&eY({files:[o]})&&(t2.shareFiles=[o],t2.hidden=!1)}catch(e){console.error(e)}window.requestAnimationFrame(()=>{tH.open=!0})}function od(e){let[t,o]=oo.maxImageDimensions.value.split("x"),i=Number(t)||800,n=Number(o)||600,a=e.width,r=e.height;a>r?a>i&&(r*=i/a,a=i):r>n&&(a*=n/r,r=n),tF.setDimensions({width:a,height:r})}function ou(){tF.draw(os,tB.getAll()).show(),tG.classList.add("dropzone--accepted"),tG.disabled=!0,t0.disabled=!1,tK.hidden=!0,on.hidden=!1}function oh(e){od(os=e.target),ou()}function om(e){if(!e)return;let t=new Image,o=new FileReader;o.addEventListener("load",function(e){let o=e.target.result;t.addEventListener("load",oh),t.src=o}),o.readAsDataURL(e)}function op(e,t,o){let i=tB.getById(t).getData();switch(e.type){case"checkbox":i[o]=e.checked;break;case"number":i[o]=Number(e.value);break;default:i[o]=e.value}tF.draw(os,tB.getAll())}async function og(e){e.preventDefault();let t=e.target,o=t.querySelector('button[type="submit"]'),i=t.imageUrl.value,n=`<strong>Error loading image</strong><br><small class="d-block text-truncate">Failed to fetch image from ${i||""}.</small>`;if(i.trim()){o.disabled=!0,o.querySelector(".spinner").hidden=!1,o.querySelector(".label").hidden=!0;try{let e=await ty({url:i}).catch(()=>{tD(n,{trustDangerousInnerHTML:!0,variant:"danger"})});e&&om(e)}catch{tD(n,{trustDangerousInnerHTML:!0,variant:"danger"})}finally{o.disabled=!1,o.querySelector(".spinner").hidden=!0,o.querySelector(".label").hidden=!1}}}function ob(e,t){return function(){let o=document.getElementById(e),i=o.querySelector('[data-input="offsetY"]'),n=o.querySelector('[data-input="offsetX"]'),a=tB.getById(e);if(!a)return;let r=a.getData();switch(t=t.toLowerCase()){case"up":r.offsetY-=1,i.value=r.offsetY;break;case"down":r.offsetY+=1,i.value=r.offsetY;break;case"left":r.offsetX-=1,n.value=r.offsetX;break;case"right":r.offsetX+=1,n.value=r.offsetX}tF.draw(os,tB.getAll()),ol=requestAnimationFrame(ob(e,t))}}async function of(e){let t=e.target.closest("button");if(!t)return;let o=t.querySelector("img"),i=`<strong>Error loading image</strong><br><small>Failed to load image: "${o.alt||""}".</small>`;try{let e=await ty({url:o.src}).catch(()=>{tD(i,{trustDangerousInnerHTML:!0,variant:"danger"})});e&&om(e)}catch{tD(i,{trustDangerousInnerHTML:!0,variant:"danger"})}}function ov(e={}){let{el:t,isTorchOn:o}={...{el:document.getElementById("torchButton"),isTorchOn:!1},...e},i=t.querySelectorAll("svg path");2===i.length&&(i[0].style.display=o?"none":"block",i[1].style.display=o?"block":"none",t.setAttribute("aria-label",`Turn ${o?"off":"on"} flash`))}async function oy(e){let t=e.target.getTrackCapabilities();t?.torch&&(tW?.removeAttribute("hidden"),tq?.hasAttribute("torch")&&ov({el:tW,isTorchOn:!0}));let o=await eK.getVideoInputDevices();o.forEach((e,t)=>{let o=document.createElement("option");o.value=e.deviceId,o.textContent=e.label||`Camera ${t+1}`,tU.appendChild(o)}),o.length>1&&tU?.removeAttribute("hidden")}document.addEventListener("tt-theme-change",function(e){let t=e.detail.theme,o=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light";document.documentElement.setAttribute("data-bs-theme","system"===t?o:t)}),document.addEventListener("web-share:error",function(){tH.open=!1,tD("<strong>Error sharing</strong><br><small>There was an error while trying to share your meme.</small>",{trustDangerousInnerHTML:!0,variant:"danger"})}),document.addEventListener("capture-photo:video-play",oy,{once:!0}),document.addEventListener("capture-photo:error",function(e){let t=e.detail.error,o="An error occurred while trying to capture photo.";t instanceof Error&&("NotAllowedError"===t.name||"NotFoundError"===t.name)&&(o+=" Make sure you have a camera connected and you have granted the appropriate permissions."),tD(`<strong>Error capturing photo</strong><br><small>${o}</small>`,{trustDangerousInnerHTML:!0,variant:"danger"}),tP.open=!1,console.error(t)}),document.addEventListener("capture-photo:success",function(e){tP.open=!1;let t=new Image;t.addEventListener("load",oh),t.src=e.detail.dataURI}),document.addEventListener("me-open",function(e){"videoModal"===e.target.id&&tq&&"function"==typeof tq.startVideoStream&&tq.startVideoStream()}),document.addEventListener("me-close",function(e){"videoModal"===e.target.id&&tq&&"function"==typeof tq.stopVideoStream&&tq.stopVideoStream(),"removeConfirmationModal"===e.target.id&&ot.reset()}),document.addEventListener("emoji-click",function(e){let t=e.target.closest('[data-section="textbox"]');if(t){let o=t.querySelector('[data-input="text"]'),i=e.detail.unicode;o&&eU(o,i)}}),document.addEventListener("textbox-create",function(e){let t=e.detail.textbox,o=tB.createElement(t,or);or=!0,tZ.appendChild(o),t.getData().text&&tF.draw(os,tB.getAll())}),document.addEventListener("textbox-remove",function(e){let t=document.getElementById(e.detail.id);t&&t.remove(),tZ.querySelectorAll('[data-section="textbox"]').forEach((e,t)=>{e.querySelector('[data-input="text"]').setAttribute("placeholder",`Text #${t+1}`)}),tF.draw(os,tB.getAll())}),tX.addEventListener("click",function(){"function"==typeof tG.openFileDialog&&(tG.disabled=!1,tG.openFileDialog())}),t1.addEventListener("click",function(){tP.open=!0}),tQ.addEventListener("click",function(){return tB.create()}),t0.addEventListener("click",oc),t5.addEventListener("click",()=>tH.open=!1),tJ.addEventListener("submit",og),tG.addEventListener("files-dropzone-drop-accepted",function(e){let[t]=e.detail.acceptedFiles;t&&om(t)}),tZ.addEventListener("input",function(e){let t=e.target,o={text:"text",fillColor:"fillColor",strokeColor:"strokeColor",font:"font",fontSize:"fontSize",fontWeight:"fontWeight",textAlign:"textAlign",shadowBlur:"shadowBlur",offsetY:"offsetY",offsetX:"offsetX",rotate:"rotate",strokeWidth:"strokeWidth",textBackgroundEnabled:"textBackgroundEnabled",textBackgroundColor:"textBackgroundColor"}[t.dataset.input];if(!o)return;let i=t.closest('[data-section="textbox"]').id;op(t,i,o)}),tZ.addEventListener("change",function(e){let t,o=e.target,i=o.closest('[data-section="textbox"]').id;o.matches('[data-input="allCaps"]')&&(t="allCaps"),t&&op(o,i,t)}),tZ.addEventListener("click",function(e){let t=e.target;if(t.matches('[data-button="settings"]')){let e=t.closest('[data-section="textbox"]'),o=e?.querySelector('[data-section="advanced-settings"]');o&&(o.hidden=!o.hidden)}if(t.matches('[data-button="duplicate-text-box"')){let e=t.closest('[data-section="textbox"]'),o=tB.getById(e.id);tB.create({...o.data})}if(t.matches('[data-button="delete-text-box"]')){let e=t.closest('[data-section="textbox"]').id,o=tB.getById(e);if(o&&o.data.text.trim()){let t=ot["textbox-id"];t&&(t.value=e,oe.open=!0)}else tB.remove(e)}}),tZ.addEventListener("pointerdown",function(e){let t=e.target,o=t.closest('[data-section="textbox"]');o&&t.matches('[data-action="move-text"]')&&(ol=requestAnimationFrame(ob(o.id,t.getAttribute("aria-label"))))}),tZ.addEventListener("pointerup",function(e){e.target.matches('[data-action="move-text"]')&&(cancelAnimationFrame&&cancelAnimationFrame(ol),ol=null)}),tZ.addEventListener("pointerout",function(e){e.target.matches('[data-action="move-text"]')&&(cancelAnimationFrame&&cancelAnimationFrame(ol),ol=null)}),tZ.addEventListener("keydown",function(e){let t=e.target,o=t.closest('[data-section="textbox"]');t.matches('[data-action="move-text"]')&&(" "===e.key||"Enter"===e.key)&&(ol&&cancelAnimationFrame(ol),ol=requestAnimationFrame(ob(o.id,t.getAttribute("aria-label"))))}),tZ.addEventListener("keyup",function(e){e.target.matches('[data-action="move-text"]')&&(" "===e.key||"Enter"===e.key)&&(ol&&cancelAnimationFrame(ol),ol=null)}),tY.addEventListener("change",function(e){t7.forEach(t=>t.hidden=t.id!==e.target.value),oo.hidden="solidColorForm"===e.target.value}),t4.addEventListener("click",of),t9.addEventListener("input",function(e){let t=e.target.value.toLowerCase().trim();t4.querySelectorAll("button").forEach(e=>{let o=(e.querySelector("img").getAttribute("alt")||"").toLowerCase();e.hidden=!o.includes(t)}),t8.hidden=!!t4.querySelector("button:not([hidden])")}),t6.addEventListener("input",function(e){e.target===t6.canvasColor&&(os=e.target.value),"string"==typeof os&&(tF.setDimensions({width:Number(t6.canvasWidth.value)||800,height:Number(t6.canvasHeight.value)||600}),ou())}),ot.addEventListener("submit",function(e){e.preventDefault();let t=e.target["textbox-id"].value;t&&(tB.remove(t),oe.open=!1)}),oo.addEventListener("change",function(e){e.target.matches('[name="maxImageDimensions"]')&&tE.set("maxImageDimensions",e.target.value),!os||"string"==typeof os||(od(os),tF.draw(os,tB.getAll()))}),on.addEventListener("click",function(e){os&&(e.stopPropagation(),os=null,tG.classList.remove("dropzone--accepted"),t0.disabled=!0,tK.hidden=!1,on.hidden=!0,tG.disabled=!1,tF.clear().hide())}),tU.addEventListener("change",function(e){if(null===tq||"function"!=typeof tq.restartVideoStream||tq.hasAttribute("loading"))return;let t=e.target.value||void 0;tq.restartVideoStream(t)}),tV.addEventListener("click",function(){null===tq||"function"!=typeof tq.capture||tq.hasAttribute("loading")||tq.capture()}),tW.addEventListener("click",function(e){null!==tq&&(tq.torch=!tq.torch,ov({el:e.currentTarget,isTorchOn:tq.hasAttribute("torch")}))}),window.addEventListener("beforeunload",function(e){(function(){let e=null!==os;for(let t of tB.getAll().values())if(!tB.hasDefaultValues(t.data)){e=!0;break}return e})()&&(e.preventDefault(),e.returnValue=!0)}),t4.querySelectorAll("button > img")?.forEach(e=>{e.setAttribute("title",e.getAttribute("alt"))}),tB.create(),tG.accept=tf,function(e,t){if(!t)return;let o=e.map(e=>e.split("/")[1]),i=`Supported image formats: ${o.join(", ")}`,n=document.createElement("div"),a=document.createElement("small");a.textContent=i,n.appendChild(a),t.appendChild(a)}(tf,tK),tO.forEach(({name:e,path:t,style:o,weight:i})=>{t$(e,t,{style:o,weight:i})}),oa&&(oi.value=oa),oi.disabled=!1;
//# sourceMappingURL=meme-generator.38d4f49d.js.map
