        ...
        <div class="col-4 mb-3">
          ...
          <select class="form-select" data-input="font" id="fontInput_${t}">
            ...
            <optgroup label="Google fonts">
              ${Y.map(({name:t,label:e})=>`<option value="${t}">${e}</option>`)}
            </optgroup>
          </select>
        </div>
