...
`;class b extends HTMLElement{#e=null;#t=null;#s=void 0;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(m.content.cloneNode(!0)),this.shadowRoot&&(this.#e=this.shadowRoot.querySelector("dialog"),this.#t=this.shadowRoot.querySelector('slot[name="footer"]'))}static get observedAttributes(){return["open","no-header","no-animations","no-close-button"]}attributeChangedCallback(t,e,o){if(null!==this.#e){if("open"===t&&e!==o&&(this.open?(this.#e.showModal(),document.body&&(document.body.style.overflowY="hidden"),this.dispatchEvent(new CustomEvent("me-open",{bubbles:!0,composed:!0,detail:{element:this}}))):this.#e.close()),"no-header"===t&&e!==o){let t=this.#e.querySelector(".dialog__header");null!==t&&(t.hidden=this.noHeader)}if("no-animations"===t&&e!==o&&this.#e.classList.toggle("dialog--no-animations",this.noAnimations),"no-close-button"===t&&e!==o){let t=this.#e.querySelector(".dialog__close");null!==t&&(t.hidden=this.noCloseButton)}}}connectedCallback(){this.#i("open"),this.#i("staticBackdrop"),this.#i("noHeader"),this.#i("noAnimations"),this.#i("noCloseButton"),this.#i("fullscreen"),this.#e?.addEventListener("click",this.#n),this.#e?.addEventListener("close",this.#l),this.#e?.addEventListener("cancel",this.#o),this.#e?.querySelector('form[method="dialog"]')?.addEventListener("submit",this.#r),this.#t?.addEventListener("slotchange",this.#a)}disconnectedCallback(){this.#s&&clearTimeout(this.#s),this.#e?.addEventListener("click",this.#n),this.#e?.removeEventListener("close",this.#l),this.#e?.removeEventListener("cancel",this.#o),this.#e?.querySelector('form[method="dialog"]')?.removeEventListener("submit",this.#r),this.#t?.removeEventListener("slotchange",this.#a)}get open(){return this.hasAttribute("open")}set open(t){t?this.setAttribute("open",""):this.removeAttribute("open")}get staticBackdrop(){return this.hasAttribute("static-backdrop")}set staticBackdrop(t){t?this.setAttribute("static-backdrop",""):this.removeAttribute("static-backdrop")}get noHeader(){return this.hasAttribute("no-header")}set noHeader(t){t?this.setAttribute("no-header",""):this.removeAttribute("no-header")}get noAnimations(){return this.hasAttribute("no-animations")}set noAnimations(t){t?this.setAttribute("no-animations",""):this.removeAttribute("no-animations")}get noCloseButton(){return this.hasAttribute("no-close-button")}set noCloseButton(t){t?this.setAttribute("no-close-button",""):this.removeAttribute("no-close-button")}get fullscreen(){return this.hasAttribute("fullscreen")}set fullscreen(t){t?this.setAttribute("fullscreen",""):this.removeAttribute("fullscreen")}#h(){this.#s||(this.#e?.classList.add("dialog--pulse"),this.#s=setTimeout(()=>{this.#e?.classList.remove("dialog--pulse"),clearTimeout(this.#s),this.#s=void 0},300))}#l=()=>{this.open=!1,document.body&&(document.body.style.overflowY=""),this.dispatchEvent(new CustomEvent("me-close",{bubbles:!0,composed:!0,detail:{element:this}}))};#o=t=>{let e=this.#u("escape-key");this.dispatchEvent(e),e.defaultPrevented&&(t.preventDefault(),this.noAnimations||this.#h())};#r=t=>{let e=this.#u("close-button");this.dispatchEvent(e),e.defaultPrevented&&(t.preventDefault(),this.noAnimations||this.#h())};#n=t=>{if(t.target!==t.currentTarget)return;let e=this.#u("backdrop-click");if(this.dispatchEvent(e),e.defaultPrevented||this.staticBackdrop){this.noAnimations||this.#h();return}this.#e?.close()};#a=()=>{if(null===this.#e)return;let t=this.#e.querySelector(".dialog__footer");if(null===t)return;let e=this.#t?.assignedNodes(),o=!!e&&e.length>0;t.hidden=!o};#u(t){return new CustomEvent("me-request-close",{bubbles:!0,composed:!0,cancelable:!0,detail:{reason:t,element:this}})}#i(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}show(){this.open||(this.open=!0)}hide(){this.open&&(this.open=!1)}static defineCustomElement(t="modal-element"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,b)}}b.defineCustomElement(),Object.defineProperty({},"FilesDropzone",{get:function(){return R},set:void 0,enumerable:!0,configurable:!0});let g=new Map([["aac","audio/aac"],["abw","application/x-abiword"],["arc","application/x-freearc"],["avif","image/avif"],["avi","video/x-msvideo"],["azw","application/vnd.amazon.ebook"],["bin","application/octet-stream"],["bmp","image/bmp"],["bz","application/x-bzip"],["bz2","application/x-bzip2"],["cda","application/x-cdf"],["csh","application/x-csh"],["css","text/css"],["csv","text/csv"],["doc","application/msword"],["docx","application/vnd.openxmlformats-officedocument.wordprocessingml.document"],["eot","application/vnd.ms-fontobject"],["epub","application/epub+zip"],["gz","application/gzip"],["gif","image/gif"],["heic","image/heic"],["heif","image/heif"],["htm","text/html"],["html","text/html"],["ico","image/vnd.microsoft.icon"],["ics","text/calendar"],["jar","application/java-archive"],["jpeg","image/jpeg"],["jpg","image/jpeg"],["jxl","image/jxl"],["js","text/javascript"],["json","application/json"],["jsonld","application/ld+json"],["markdown","text/markdown"],["md","text/markdown"],["mid","audio/midi"],["midi","audio/midi"],["mjs","text/javascript"],["mp3","audio/mpeg"],["mp4","video/mp4"],["mpeg","video/mpeg"],["mpkg","application/vnd.apple.installer+xml"],["odp","application/vnd.oasis.opendocument.presentation"],["ods","application/vnd.oasis.opendocument.spreadsheet"],["odt","application/vnd.oasis.opendocument.text"],["oga","audio/ogg"],["ogv","video/ogg"],["ogx","application/ogg"],["opus","audio/opus"],["otf","font/otf"],["png","image/png"],["pdf","application/pdf"],["php","application/x-httpd-php"],["ppt","application/vnd.ms-powerpoint"],["pptx","application/vnd.openxmlformats-officedocument.presentationml.presentation"],["rar","application/vnd.rar"],["rtf","application/rtf"],["sh","application/x-sh"],["svg","image/svg+xml"],["swf","application/x-shockwave-flash"],["tar","application/x-tar"],["tif","image/tiff"],["tiff","image/tiff"],["ts","video/mp2t"],["ttf","font/ttf"],["txt","text/plain"],["vsd","application/vnd.visio"],["wav","audio/wav"],["weba","audio/webm"],["webm","video/webm"],["webp","image/webp"],["woff","font/woff"],["woff2","font/woff2"],["xhtml","application/xhtml+xml"],["xls","application/vnd.ms-excel"],["xlsx","application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"],["xml","application/xml"],["xul","application/vnd.mozilla.xul+xml"],["zip","application/zip"],["7z","application/x-7z-compressed"],["mkv","video/x-matroska"],["mov","video/quicktime"],["msg","application/vnd.ms-outlook"]]),f=[".DS_Store","Thumbs.db"],v=t=>{let{name:e}=t;if(e&&-1!==e.lastIndexOf(".")&&!t.type){let o=(e.split(".").pop()||"").toLowerCase(),i=g.get(o);i&&Object.defineProperty(t,"type",{value:i,writable:!1,configurable:!1,enumerable:!0})}return t},y=(t,e)=>{let o=v(t);if("string"!=typeof o.path){let{webkitRelativePath:i}=t;Object.defineProperty(o,"path",{value:"string"==typeof e?e:i||t.name,writable:!1,configurable:!1,enumerable:!0})}return o},w=async t=>await new Promise((e,o)=>{t.readEntries(e,o)}),E=async t=>{let e=[],o=await w(t);for(;o.length>0;)e.push(...o),o=await w(t);return e},x=t=>new Promise((e,o)=>{t.file(o=>e(y(o,t.fullPath)),o)}),S=async t=>{let e=[],o=[];for(let e of t){if("file"!==e.kind)continue;let t=e.getAsEntry?e.getAsEntry():e.webkitGetAsEntry();o.push(t)}for(;o.length>0;){let t=o.shift();if(t){if(t.isFile){let o=await x(t);-1===f.indexOf(o.name)&&e.push(o)}else t.isDirectory&&o.push(...await E(t.createReader()))}}return e},A=async t=>{let e=[];for(let o of t)-1===f.indexOf(o.name)&&e.push(y(o));return e},k=async t=>t.dataTransfer?t.dataTransfer.items?await S(t.dataTransfer.items):await A(t.dataTransfer.files):await A(t.target.files),z="files-dropzone",C="TOO_MANY_FILES",L=document.createElement("template"),_=`
  *,
  *::before,
  *::after {
    box-sizing: border-box;
...
`;class R extends HTMLElement{#e=null;#t=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(L.content.cloneNode(!0)),this.shadowRoot&&(this.#e=this.shadowRoot.getElementById("fileInput"),this.#t=this.shadowRoot.getElementById("dropzoneEl"))}static get observedAttributes(){return["accept","disabled","multiple","no-keyboard"]}attributeChangedCallback(t,e,o){"accept"===t&&e!==o&&this.#e&&(this.#e.accept=this.accept),"disabled"===t&&e!==o&&this.#e&&(this.#e.disabled=this.disabled,this.disabled?this.#t?.removeAttribute("tabindex"):this.#t?.setAttribute("tabindex","0")),"multiple"===t&&e!==o&&this.#e&&(this.#e.multiple=this.multiple),"no-keyboard"===t&&e!==o&&this.#t&&(this.noKeyboard?this.#t.removeAttribute("tabindex"):this.#t.setAttribute("tabindex","0"))}connectedCallback(){this.#s("accept"),this.#s("disabled"),this.#s("maxFiles"),this.#s("maxSize"),this.#s("minSize"),this.#s("multiple"),this.#s("noClick"),this.#s("noDrag"),this.#s("noKeyboard"),this.#s("autoFocus"),this.#s("noStyle"),this.#e?.addEventListener("change",this.#i),this.#t?.addEventListener("dragenter",this.#a),this.#t?.addEventListener("dragover",this.#n),this.#t?.addEventListener("dragleave",this.#r),this.#t?.addEventListener("drop",this.#o),this.#t?.addEventListener("click",this.#h),this.#t?.addEventListener("keyup",this.#l),this.autoFocus&&this.#t?.focus()}disconnectedCallback(){this.#e?.removeEventListener("change",this.#i),this.#t?.removeEventListener("dragenter",this.#a),this.#t?.removeEventListener("dragover",this.#n),this.#t?.removeEventListener("dragleave",this.#r),this.#t?.removeEventListener("drop",this.#o),this.#t?.removeEventListener("click",this.#h),this.#t?.removeEventListener("keyup",this.#l)}get accept(){return this.getAttribute("accept")||""}set accept(t){this.setAttribute("accept",null!=t?t.toString():t)}get disabled(){return this.hasAttribute("disabled")}set disabled(t){this.toggleAttribute("disabled",!!t)}get maxFiles(){let t=Number(this.getAttribute("max-files"))||0;return t<=0?1/0:Math.floor(Math.abs(t))}set maxFiles(t){this.setAttribute("max-files",null!=t?t.toString():t)}get maxSize(){let t=this.getAttribute("max-size");if(null===t)return 1/0;let e=Number(t);return Number.isNaN(e)?1/0:e}set maxSize(t){this.setAttribute("max-size",null!=t?t.toString():t)}get minSize(){let t=this.getAttribute("min-size");if(null===t)return 0;let e=Number(t);return Number.isNaN(e)?0:e}set minSize(t){this.setAttribute("min-size",null!=t?t.toString():t)}get multiple(){return this.hasAttribute("multiple")}set multiple(t){this.toggleAttribute("multiple",!!t)}get noClick(){return this.hasAttribute("no-click")}set noClick(t){this.toggleAttribute("no-click",!!t)}get noDrag(){return this.hasAttribute("no-drag")}set noDrag(t){this.toggleAttribute("no-drag",!!t)}get noKeyboard(){return this.hasAttribute("no-keyboard")}set noKeyboard(t){this.toggleAttribute("no-keyboard",!!t)}get autoFocus(){return this.hasAttribute("auto-focus")}set autoFocus(t){this.toggleAttribute("auto-focus",!!t)}get noStyle(){return this.hasAttribute("no-style")}set noStyle(t){this.toggleAttribute("no-style",!!t)}#i=async t=>{try{this.#m(await k(t))}catch(t){this.dispatchEvent(new CustomEvent(`${z}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}};#a=()=>{this.disabled||this.noDrag||this.dispatchEvent(new Event(`${z}-dragenter`,{bubbles:!0,composed:!0}))};#n=t=>{if(t.preventDefault(),this.disabled||this.noDrag){t.dataTransfer.dropEffect="none";return}t.dataTransfer.dropEffect="copy",this.#t&&(this.#t.classList.add("dropzone--dragover"),this.#t.part.add("dropzone--dragover")),this.dispatchEvent(new Event(`${z}-dragover`,{bubbles:!0,composed:!0}))};#r=()=>{this.disabled||this.noDrag||(this.#t&&(this.#t.classList.remove("dropzone--dragover"),this.#t.part.remove("dropzone--dragover")),this.dispatchEvent(new Event(`${z}-dragleave`,{bubbles:!0,composed:!0})))};#o=async t=>{if(!this.disabled&&!this.noDrag){t.preventDefault(),this.#t&&(this.#t.classList.remove("dropzone--dragover"),this.#t.part.remove("dropzone--dragover"));try{this.#m(await k(t))}catch(t){this.dispatchEvent(new CustomEvent(`${z}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}};#h=()=>{this.disabled||this.noClick||this.#e?.click()};#l=t=>{this.disabled||this.noKeyboard||" "!==t.key&&"Enter"!==t.key||this.#e?.click()};#m(t){if(!Array.isArray(t)||!t.length)return;let e=[],o=[],i=t.length;if(!this.multiple&&i>1)for(let e of t)o.push({file:e,errors:[{code:C,message:"Too many files selected. Only 1 file is allowed."}]});else if(this.multiple&&i>this.maxFiles)for(let e of t)o.push({file:e,errors:[{code:C,message:`Too many files selected. Only ${this.maxFiles} ${this.maxFiles>1?"files are":"file is"} allowed.`}]});else for(let i of t){let t=function(t,e=""){if(!e)return!0;let o=[...new Set(e.split(",").map(t=>t.trim()).filter(Boolean))],i=t.type,a=i.replace(/\/.*$/,"");for(let e of o)if("."===e.charAt(0)){if(-1!==t.name.toLowerCase().indexOf(e.toLowerCase(),t.name.length-e.length))return!0}else if(/\/\*$/.test(e)){if(a===e.replace(/\/.*$/,""))return!0}else if(i===e)return!0;return!1}(i,this.accept),a=i.size>this.maxSize,n=i.size<this.minSize;if(!t||a||n){let e=[];t||e.push({code:"INVALID_MIME_TYPE",message:`File type "${i.type}" is not accepted.`}),a&&e.push({code:"FILE_TOO_LARGE",message:`File size ${i.size} exceeds the maximum size of ${this.maxSize}.`}),n&&e.push({code:"FILE_TOO_SMALL",message:`File size ${i.size} is smaller than the minimum size of ${this.minSize}.`}),o.push({file:i,errors:e})}else e.push(i)}this.dispatchEvent(new CustomEvent(`${z}-drop`,{bubbles:!0,composed:!0,detail:{acceptedFiles:e,rejectedFiles:o}})),e.length>0&&this.dispatchEvent(new CustomEvent(`${z}-drop-accepted`,{bubbles:!0,composed:!0,detail:{acceptedFiles:e}})),o.length>0&&this.dispatchEvent(new CustomEvent(`${z}-drop-rejected`,{bubbles:!0,composed:!0,detail:{rejectedFiles:o}})),this.#e&&(this.#e.value=this.#e.defaultValue)}openFileDialog(){this.disabled||this.#e?.click()}#s(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t=z){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,R)}}R.defineCustomElement();const T=(t,...e)=>{if(!Array.isArray(t))throw TypeError("Expected an array for first argument");return t.filter((t,o)=>-1===e.indexOf(o))},B=(t="",e="")=>{let o=Math.random().toString(36).substring(2,8);return`${"string"==typeof t&&""!==t?t+"-":""}${o}${"string"==typeof e&&""!==e?"-"+e:""}`},F=["image/jpg","image/jpeg","image/png","image/apng","image/gif","image/webp","image/avif"];var $={};$=new URL("Pressuru.684952ea.ttf",import.meta.url).toString();var N={};N=new URL("Oswald-Regular.89ec7d89.ttf",import.meta.url).toString();var O={};O=new URL("Oswald-Bold.0f6a7ca6.ttf",import.meta.url).toString();var H={};H=new URL("Roboto-Regular.ca197847.ttf",import.meta.url).toString();var I={};I=new URL("Roboto-Bold.fdb9b54a.ttf",import.meta.url).toString();var M={};M=new URL("RobotoCondensed-Regular.d585f5c7.ttf",import.meta.url).toString();var q={};q=new URL("RobotoCondensed-Bold.e1f96d4b.ttf",import.meta.url).toString();var P={};P=new URL("CourierPrime-Regular.3a25a501.ttf",import.meta.url).toString();var j={};j=new URL("CourierPrime-Bold.3d6bf689.ttf",import.meta.url).toString();var U={};U=new URL("OpenSans-Regular.edf9e01b.ttf",import.meta.url).toString();var D={};D=new URL("OpenSans-Bold.8fceb72b.ttf",import.meta.url).toString();const W=[{name:"Pressuru",label:"Pressuru",path:t($),style:"normal",weight:"400"},{name:"Oswald-Regular",label:"Oswald",path:t(N),style:"normal",weight:"400"},{name:"Oswald-Bold",label:"Oswald Bold",path:t(O),style:"normal",weight:"700"},{name:"Roboto-Regular",label:"Roboto",path:t(H),style:"normal",weight:"400"},{name:"Roboto-Bold",label:"Roboto Bold",path:t(I),style:"normal",weight:"700"},{name:"RobotoCondensed-Regular",label:"Roboto Condensed",path:t(M),style:"normal",weight:"400"},{name:"RobotoCondensed-Bold",label:"Roboto Condensed Bold",path:t(q),style:"normal",weight:"700"},{name:"CourierPrime-Regular",label:"Courier Prime",path:t(P),style:"normal",weight:"400"},{name:"CourierPrime-Bold",label:"Courier Prime Bold",path:t(j),style:"normal",weight:"700"},{name:"OpenSans-Regular",label:"Open Sans",path:t(U),style:"normal",weight:"400"},{name:"OpenSans-Bold",label:"Open Sans Bold",path:t(D),style:"normal",weight:"400"}],Y=async(t,e,o={})=>{try{let i=new FontFace(t,`url(${e})`,{...o});await i.load(),document.fonts.add(i)}catch(t){console.error(t)}},V=async(t={})=>{let e=await fetch(t.url),o=await e.blob(),i=t.mimeType||o.type||"";if(!F.includes(i))throw Error(`This is not an accepted image format. Accepted MIME types are: ${F.join(", ")}`);return new File([o],t.filename||"",o)},X=document.getElementById("errorsContainer"),G=t=>{let e=t.currentTarget;e.removeEventListener("click",G),X.removeChild(e.parentNode)},K=(t="",e="info")=>{["info","warning","danger"].includes(e)||(e="info");let o=`
  ...
  `,i=document.createDocumentFragment(),a=document.createElement("div");return a.className="bg-light border shadow-sm mb-3 rounded",a.setAttribute("data-section","textBox"),a.setAttribute("data-index",t),a.innerHTML=o,a.querySelector('[data-input="font"]').value=e.font,a.querySelector('[data-input="textAlign"]').value=e.textAlign,a.querySelector('[data-input="allCaps"]').checked=e.allCaps,i.appendChild(a)},Z=(t,e,o,i=[])=>{null!=t&&(o.clearRect(0,0,e.width,e.height),"string"==typeof t?(o.fillStyle=t,o.fillRect(0,0,e.width,e.height)):o.drawImage(t,0,0,e.width,e.height),i.forEach(function(t,i){o.save(),o.font=`${t.fontWeight} ${t.fontSize}px ${t.font}`,o.fillStyle=t.fillColor,o.textAlign=t.textAlign,o.strokeStyle=t.shadowColor;let a=o.measureText("M").width+t.fontSize/2,n=e.width/2,r=t.shadowBlur,s=(!0===t.allCaps?t.text.toUpperCase():t.text).split("\n");0!==r&&(o.shadowOffsetX=0,o.shadowOffsetY=0,o.shadowBlur=r,o.shadowColor=t.shadowColor),o.translate(n+t.offsetX,a*(i+1)+t.offsetY),o.rotate(t.rotate*Math.PI/180),s.forEach((t,e)=>o.fillText(t,0,e*a)),o.shadowBlur=0,s.forEach((t,e)=>o.fillText(t,0,e*a)),t.borderWidth>0&&(o.lineWidth=t.borderWidth,s.forEach((t,e)=>o.strokeText(t,0,e*a))),o.restore()}))},Q=document.getElementById("videoModal"),tt=document.getElementById("downloadModal"),te=document.getElementById("canvas"),to=document.querySelector("files-dropzone"),ti=document.getElementById("instructions"),ta=te.getContext("2d"),tn=document.getElementById("imageUploadMethodSelect"),tr=document.getElementById("fileSelectBtn"),ts=document.getElementById("imageUrlForm"),tl=document.getElementById("addTextboxBtn"),td=document.getElementById("inputsContainer"),tc=document.getElementById("generateMemeBtn"),th=document.getElementById("openVideoModalBtn"),tu=document.getElementById("downloadMemeBtn"),tp=document.getElementById("downloadMemePreview"),tm=document.querySelector("web-share"),tb=document.getElementById("gallery"),tg=document.getElementById("gallerySearch"),tf=tb.querySelector(".gallery__no-results"),tv=document.getElementById("solidColorForm"),ty=document.querySelectorAll(".upload-method"),tw=document.getElementById("removeConfirmationModal"),tE=document.getElementById("removeTextForm");let tx=null,tS=null;const tA={_isSettingsOpen:!1,text:"",fillColor:"#ffffff",shadowColor:"#000000",font:"Pressuru",fontSize:40,fontWeight:"normal",textAlign:"center",shadowBlur:3,borderWidth:1,offsetY:0,offsetX:0,rotate:0,allCaps:!0};let tk=[{...tA}];const tz=async()=>{let t=te.toDataURL("image/png"),e=t.replace("image/png","image/octet-stream");if(tu.download=`${B("meme")}.png`,tu.href=e,tp.width=te.width,tp.height=te.height,tp.src=e,n())try{let e=await V({url:t,filename:`${B("meme")}.png`,mimeType:"image/png"}).catch(t=>K(t.message,"danger"));e&&n({files:[e]})&&(tm.shareFiles=[e],tm.hidden=!1)}catch(t){console.error(t)}window.requestAnimationFrame(()=>{tt.open=!0})},tC=t=>{let e=t.target.width,o=t.target.height;e>o?e>4e3&&(o*=4e3/e,e=4e3):o>3e3&&(e*=3e3/o,o=3e3),te.width=e,te.height=o,Z(tx=t.target,te,ta,tk),tc.disabled=!1,te.hidden=!1,ti.hidden=!0},tL=t=>{tk=T(tk,t),td.querySelectorAll('[data-section="textBox"]').forEach(t=>t.remove()),tk.forEach((t,e)=>td.appendChild(J(e,t))),Z(tx,te,ta,tk)},t_=t=>{if(!t)return;let e=new Image,o=new FileReader;o.addEventListener("load",function(t){let o=t.target.result;e.addEventListener("load",tC),e.src=o}),o.readAsDataURL(t)},tR=(t,e,o)=>{"checkbox"===t.type?tk[e][o]=t.checked:"number"===t.type?tk[e][o]=Number(t.value):tk[e][o]=t.value,Z(tx,te,ta,tk)},tT=async t=>{t.preventDefault();let e=t.target,o=e.querySelector('button[type="submit"]'),i=e.imageUrl.value;if(i.trim()){o.disabled=!0,o.querySelector(".spinner").hidden=!1,o.querySelector(".label").hidden=!0;try{let t=await V({url:i}).catch(t=>K(t.message,"danger"));t&&t_(t)}catch(t){K(`Failed to load image from "${i}".`,"danger")}finally{o.disabled=!1,o.querySelector(".spinner").hidden=!0,o.querySelector(".label").hidden=!1}}},tB=(t,e,o)=>()=>{let i=document.querySelectorAll('[data-section="textBox"]')[o],a=i.querySelector('[data-input="offsetY"]'),n=i.querySelector('[data-input="offsetX"]');"offsetY"===t&&("-"===e&&(tk[o].offsetY-=1),"+"===e&&(tk[o].offsetY+=1),a.value=tk[o].offsetY),"offsetX"===t&&("-"===e&&(tk[o].offsetX-=1),"+"===e&&(tk[o].offsetX+=1),n.value=tk[o].offsetX),Z(tx,te,ta,tk),tS=requestAnimationFrame(tB(t,e,o))},tF=async t=>{let e=t.target.closest("button");if(!e)return;let o=e.querySelector("img");try{let t=await V({url:o.src}).catch(t=>K(t.message,"danger"));t&&t_(t)}catch(t){K(`Failed to load image: "${o.alt}".`,"danger")}};tr.addEventListener("click",()=>{"function"==typeof to.openFileDialog&&to.openFileDialog()}),th.addEventListener("click",()=>{Q.open=!0}),tl.addEventListener("click",()=>{let t=J(tk.length,tA);tk.push({...tA}),td.appendChild(t),t.querySelector('[data-input="text"]').focus()}),tc.addEventListener("click",tz),tu.addEventListener("click",()=>tt.open=!1),ts.addEventListener("submit",tT),to.addEventListener("files-dropzone-drop-accepted",t=>{let[e]=t.detail.acceptedFiles;e&&t_(e)}),td.addEventListener("input",t=>{let e;let o=t.target,i=Number(o.closest('[data-section="textBox"]').getAttribute("data-index"));o.matches('[data-input="text"]')?e="text":o.matches('[data-input="fillColor"]')?e="fillColor":o.matches('[data-input="shadowColor"]')?e="shadowColor":o.matches('[data-input="font"]')?e="font":o.matches('[data-input="fontSize"]')?e="fontSize":o.matches('[data-input="fontWeight"]')?e="fontWeight":o.matches('[data-input="textAlign"]')?e="textAlign":o.matches('[data-input="shadowBlur"]')?e="shadowBlur":o.matches('[data-input="offsetY"]')?e="offsetY":o.matches('[data-input="offsetX"]')?e="offsetX":o.matches('[data-input="rotate"]')?e="rotate":o.matches('[data-input="borderWidth"]')&&(e="borderWidth"),e&&tR(o,i,e)}),td.addEventListener("change",t=>{let e;let o=t.target,i=Number(o.closest('[data-section="textBox"]').getAttribute("data-index"));o.matches('[data-input="allCaps"]')&&(e="allCaps"),e&&tR(o,i,e)}),td.addEventListener("click",t=>{let e=t.target;if(e.matches('[data-button="settings"]')){let t=e.closest('[data-section="textBox"]').getAttribute("data-index");document.querySelectorAll('[data-section="textBox"]').forEach((e,o)=>{let i=e.querySelector('[data-section="settings"]');e.getAttribute("data-index")===t?(i.hidden=!i.hidden,tk[o]._isSettingsOpen=!tk[o]._isSettingsOpen):(i.hidden=!0,tk[o]._isSettingsOpen=!1)})}if(e.matches('[data-button="delete-text-box"]')){let t=Number(e.closest('[data-section="textBox"]').getAttribute("data-index"));if(tk[t].text.trim()){let e=tE["text-index"];e&&(e.value=t,tw.open=!0)}else tL(t)}}),td.addEventListener("pointerdown",t=>{let e=t.target;if(!e.closest('[data-section="textBox"]'))return;let o=Number(e.closest('[data-section="textBox"]').getAttribute("data-index")),i=e.matches('[data-move="offsetY"]'),a=e.matches('[data-move="offsetX"]');if(!i&&!a)return;let n=e.getAttribute("data-move"),r=e.getAttribute("data-sign");tS=requestAnimationFrame(tB(n,r,o))}),td.addEventListener("pointerup",t=>{let e=t.target,o=e.matches('[data-move="offsetY"]'),i=e.matches('[data-move="offsetX"]');(o||i)&&(cancelAnimationFrame(tS),tS=null)}),td.addEventListener("pointerout",t=>{let e=t.target,o=e.matches('[data-move="offsetY"]'),i=e.matches('[data-move="offsetX"]');(o||i)&&tS&&(cancelAnimationFrame(tS),tS=null)}),tn.addEventListener("change",t=>{ty.forEach(e=>e.hidden=e.id!==t.target.value)}),tb.addEventListener("click",tF),tg.addEventListener("input",t=>{let e=t.target.value.toLowerCase().trim();tb.querySelectorAll("button").forEach(t=>{let o=(t.querySelector("img").getAttribute("alt")||"").toLowerCase();t.hidden=!o.includes(e)}),tf.hidden=!!tb.querySelector("button:not([hidden])")}),tv.addEventListener("input",t=>{t.target===tv.canvasColor&&(tx=t.target.value),"string"==typeof tx&&(te.width=Number(tv.canvasWidth.value)||600,te.height=Number(tv.canvasHeight.value)||400,Z(tx,te,ta,tk),tc.disabled=!1,te.hidden=!1,ti.hidden=!0)}),document.addEventListener("web-share:error",()=>{tt.open=!1,K("There was an error while trying to share your meme.","danger")}),document.addEventListener("capture-photo:error",t=>{let e=t.detail.error,o="An error occurred while trying to capture photo.";e instanceof Error&&("NotAllowedError"===e.name||"NotFoundError"===e.name)&&(o+=" Make sure you have a camera connected and you have granted the appropriate permissions."),K(o,"danger"),Q.open=!1,console.error(e)}),document.addEventListener("capture-photo:success",t=>{Q.open=!1;let e=new Image;e.addEventListener("load",tC),e.src=t.detail.dataURI}),document.addEventListener("me-open",t=>{if("videoModal"===t.target.id){let t=Q.querySelector("capture-photo");t&&"function"==typeof t.startVideoStream&&t.startVideoStream()}}),document.addEventListener("me-close",t=>{if("videoModal"===t.target.id){let t=Q.querySelector("capture-photo");t&&"function"==typeof t.stopVideoStream&&t.stopVideoStream()}"removeConfirmationModal"===t.target.id&&tE.reset()}),tE.addEventListener("submit",t=>{t.preventDefault();let e=Number(t.target["text-index"].value);e>=0&&(tL(e),tw.open=!1)}),tw.addEventListener("click",t=>{t.target?.closest("[data-close-modal]")!==null&&(tw.open=!1)}),tb.querySelectorAll("button > img")?.forEach(t=>{t.setAttribute("title",t.getAttribute("alt"))}),tk.forEach((t,e)=>{td.appendChild(J(e,t))}),to.accept=F,W.forEach(({name:t,path:e,style:o,weight:i})=>{Y(t,e,{style:o,weight:i})});
//# sourceMappingURL=index.905bb0f0.js.map
